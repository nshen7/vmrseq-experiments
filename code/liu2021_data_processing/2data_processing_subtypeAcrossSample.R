...
# ==== run ====
# for (i in 9) wrapper(subtype_smr_sel$SubType[i], mc.cores = 10) # 3829408.pbsha.ib.sockeye
# for (i in 14:15) wrapper(subtype_smr_sel$SubType[i], mc.cores = 10) # 3826297.pbsha.ib.sockeye
# for (i in 16:17) wrapper(subtype_smr_sel$SubType[i], mc.cores = 20) # 3825368.pbsha.ib.sockeye
# for (i in 18:19) wrapper(subtype_smr_sel$SubType[i], mc.cores = 20) # 3825373.pbsha.ib.sockeye
# for (i in 20:21) wrapper(subtype_smr_sel$SubType[i], mc.cores = 20) # 3825377.pbsha.ib.sockeye
# for (i in 22:23) wrapper(subtype_smr_sel$SubType[i], mc.cores = 20) # 3825379.pbsha.ib.sockeye
# for (i in 24:25) wrapper(subtype_smr_sel$SubType[i], mc.cores = 20) # 3825387.pbsha.ib.sockeye
# for (i in 26:27) wrapper(subtype_smr_sel$SubType[i], mc.cores = 20) # 3825406.pbsha.ib.sockeye
# for (i in 28:29) wrapper(subtype_smr_sel$SubType[i], mc.cores = 20) # 3825410.pbsha.ib.sockeye
# for (i in 40:37) wrapper(subtype_smr_sel$SubType[i], mc.cores = 20) # 3825624.pbsha.ib.sockeye
# for (i in 44:41) wrapper(subtype_smr_sel$SubType[i], mc.cores = 20) # 3825666.pbsha.ib.sockeye
# for (i in 48:45) wrapper(subtype_smr_sel$SubType[i], mc.cores = 20) # 3825366.pbsha.ib.sockeye
# for (i in 53:49) wrapper(subtype_smr_sel$SubType[i], mc.cores = 20) # 3825367.pbsha.ib.sockeye
