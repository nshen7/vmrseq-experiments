...
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/point_siteLevel_f1_", N , "cells_",
...
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/boxplot_siteLevel_f1_", N , "cells_",
  NV, "VMRs_seed", seed, ".png"
), width = 8, height = 4)
...
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/point_siteLevel_fdr_", N , "cells_",
  NV, "VMRs_seed", seed, ".png"
), width = 8, height = 4)
smr_dft %>% ggplot(aes(color = method)) +
...
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/boxplot_siteLevel_fdr_", N , "cells_",
  NV, "VMRs_seed", seed, ".png"
), width = 8, height = 4)
...
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/point_siteLevel_power_", N , "cells_",
  NV, "VMRs_seed", seed, ".png"
), width = 8, height = 4)
smr_dft %>% ggplot(aes(color = method)) +
  ...
  theme_classic() + 
  theme(axis.text.x=element_blank(), axis.ticks.x=element_blank()) +
  ylab("Site-level power") + xlab("Sparsity level") 
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/boxplot_siteLevel_power_", N , "cells_",
  NV, "VMRs_seed", seed, ".png"
), width = 8, height = 4)
...
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/point_regionLevel_f1_", N , "cells_",
  NV, "VMRs_seed", seed, ".png"
), width = 8, height = 4)
smr_dft %>% ggplot(aes(color = method)) +
...
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/boxplot_regionLevel_f1_", N , "cells_",
  NV, "VMRs_seed", seed, ".png"
), width = 8, height = 4)
...
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/point_regionLevel_fdr_", N , "cells_",
  NV, "VMRs_seed", seed, ".png"
), width = 8, height = 4)
smr_dft %>% ggplot(aes(color = method)) +
...
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/boxplot_regionLevel_fdr_", N , "cells_",
  NV, "VMRs_seed", seed, ".png"
), width = 8, height = 4)
...
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/point_regionLevel_power_", N , "cells_",
  NV, "VMRs_seed", seed, ".png"
), width = 8, height = 4)
smr_dft %>% ggplot(aes(color = method)) +
...
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/boxplot_regionLevel_power_", N , "cells_",
  NV, "VMRs_seed", seed, ".png"
), width = 8, height = 4)
...
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/point_siteLevel_RRA_", N , "cells_",
  NV, "VMRs_seed", seed, ".png"
), width = 8, height = 4)
smr_rra %>% ggplot(aes(color = method)) +
...
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/boxplot_siteLevel_RRA_", N , "cells_",
  NV, "VMRs_seed", seed, ".png"
), width = 8, height = 4)
...
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/point_regionLevel_RRA_", N , "cells_",
  NV, "VMRs_seed", seed, ".png"
), width = 8, height = 4)
smr_rra %>% ggplot(aes(color = method)) +
...
ggsave(paste0(
  "plots/sim_studies/benchmark_real_chr/comparison/boxplot_regionLevel_RRA_", N , "cells_",
  NV, "VMRs_seed", seed, ".png"
), width = 8, height = 4)
