...
gr <- loadHDF5SummarizedExperiment(
  paste0("data/interim/sim_studies/benchmark_real_chr/modified_real/pseudoChr_IT-L23_Cux1_chr1_",
...
res_scmet <- fread("data/interim/sim_studies/benchmark_real_chr/scmet/output/pseudoChr_IT-L23_Cux1_chr1_200cells_4subpops_0.1efdr_scmetOutput.csv")
