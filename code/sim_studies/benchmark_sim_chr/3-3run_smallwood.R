...
for (N in c(500)) {
  ...
  for (NP in c(2,4,8,20)) {
    for (sparseLevel in 1:3) {
      ...
      # load input
      dir <- paste0("data/interim/sim_studies/benchmark_sim_chr/smallwood/input/simChr_",
      ...
      fwrite(
        ...
        paste0("data/interim/sim_studies/benchmark_sim_chr/smallwood/output/modelTime_",
               N, "cells_", NP, "subpops_",
               NV, "VMRs_sparseLevel", sparseLevel, 
               "_seed", seed, ".txt")
      )
