...
read_dir_2 <- "data/interim/case_studies/luo2017mice_full_sens_analysis/minN"
...
# minN <- 10
minN <- 20
summarizeOutputRegion(read_dir_1, here(read_dir_2, paste0('minN', minN)), here(write_dir, paste0('minN', minN)), methods = c("vmrseq"))
