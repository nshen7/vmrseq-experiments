...
write_dir <- here('data', 'interim', 'case_studies', 'luo2017mice_subset_hom_v2')
...
nrow(sub_metadata) # = 136 cells in total
...
fwrite(sub_metadata, here(write_dir, "metadata_luo2017mice_subset_hom.csv"))
