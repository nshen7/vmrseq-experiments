...
write_dir <- here('data', 'interim', 'case_studies', 'argelaguet2019_full', '05_plot_global_met')
if (!file.exists(write_dir)) dir.create(write_dir)
plot_dir <- here('plots', 'case_studies', 'argelaguet2019_full', '05_plot_global_met')
...
umapRegionalMeanMethyl <- function(method,
  ...
  ggsave(here(plot_dir, paste0("umap_regional_methyl_coloredByStage_", method, name_seg, "_seed", seed, ".png")), width = 7, height = 4)
  ...
  for (this_stage in unique(df_umap$stage)) {
    ...
    ggsave(here(plot_dir, paste0("umap_regional_methyl_lineage10x_2_", method, name_seg, "_seed", seed, "_stage", this_stage, ".png")), width = 7, height = 4)
    df_umap %>% 
      filter(stage == this_stage) %>%
      ...
      theme_classic() +
      ggtitle(paste0('Stage ', this_stage))
    ggsave(here(plot_dir, paste0("umap_regional_methyl_lineage10x_", method, name_seg, "_seed", seed, "_stage", this_stage, ".png")), width = 7, height = 4)
    df_umap %>% 
      filter(stage == this_stage) %>%
      ...
      ggtitle(paste0('Stage ', this_stage))
    ggsave(here(plot_dir, paste0("umap_regional_methyl_cellCyclePhase_", method, name_seg, "_seed", seed, "_stage", this_stage, ".png")), width = 7, height = 4)
  }
  ...
  # Distribution of cell cycle score in UMAP
  df_umap %>% 
    ...
    ggtitle(paste0("Method: ", method_name))
  ggsave(here(plot_dir, paste0("umap_regional_methyl_cellCycleScore_S_", method, name_seg, "_seed", seed, ".png")), width = 7, height = 4)
  df_umap %>% 
    ...
    theme_classic() +
    ggtitle(paste0("Method: ", method_name))
  ggsave(here(plot_dir, paste0("umap_regional_methyl_cellCycleScore_G2M_", method, name_seg, "_seed", seed, ".png")), width = 7, height = 4)
  
  # Distribution of cell cycle phases in UMAP
  df_umap %>% 
    ggplot(aes(umap_1, umap_2, color = Phase)) +
    geom_point(size = 0.3) +
    scale_colour_manual(values = PHASE_COLOR) + 
    theme_classic() +
    ggtitle(paste0("Method: ", method_name))
  ggsave(here(plot_dir, paste0("umap_regional_methyl_cellCyclePhase_", method, name_seg, "_seed", seed, ".png")), width = 7, height = 4)
  ...
  for (this_phase in unique(df_umap$Phase)) {
    ...
    ggsave(here(plot_dir, paste0("umap_regional_methyl_cellCyclePhase_", method, name_seg, "_seed", seed, "_phase", this_phase, ".png")), width = 7, height = 4)
  }
  
  # More strict cell cycle phase definition
  df_umap_strict <- df_umap %>% 
  ...
  df_umap_strict %>% 
    ...
    scale_colour_manual(values = PHASE_COLOR) +
    theme_classic()
  ggsave(here(plot_dir, paste0("point_cellCycleScore_G2M_vs_S_strict.png")),  width = 6, height = 5)

  # Distribution of cell cycle phases in UMAP with more strict definition
  df_umap_strict %>%
    ggplot(aes(umap_1, umap_2, color = Phase)) +
    geom_point(size = 0.3) +
    scale_colour_manual(values = PHASE_COLOR) + 
    theme_classic() +
    ggtitle(paste0("Method: ", method_name))
  ggsave(here(plot_dir, paste0("umap_regional_methyl_cellCyclePhaseStrict_", method, name_seg, "_seed", seed, ".png")), width = 7, height = 4)
  ...
  for (this_phase in unique(df_umap$Phase)) {
    df_umap_strict %>%
      ...
      theme_classic() +
      ggtitle(paste0('Phase ', this_phase))
    ggsave(here(plot_dir, paste0("umap_regional_methyl_cellCyclePhaseStrict_", method, name_seg, "_seed", seed, "_phase", this_phase, ".png")), width = 7, height = 4)
  }
}
## Run
