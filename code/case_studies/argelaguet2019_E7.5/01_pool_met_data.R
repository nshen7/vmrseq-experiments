...
write_dir <- here('data', 'interim', 'case_studies', 'argelaguet2019_E7.5', 'met', 'vmrseq', 'input')
...
# Read in metadata
md <- fread(here('data', 'metadata', 'argelaguet2019', 'argelaguet2019_E7.5_met&rna_sample_metadata_processed.csv'))
...
# data.pool(cellFiles = cell_file_dirs, writeDir = write_dir, chrNames = 6:12, colData = md)
data.pool(cellFiles = cell_file_dirs, writeDir = write_dir, chrNames = 13:19, colData = md)
# 
