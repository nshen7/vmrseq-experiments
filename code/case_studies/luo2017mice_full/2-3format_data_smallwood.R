...
write_dir <- "data/interim/case_studies/luo2017mice_full/smallwood/input/"
if (!file.exists(write_dir)) dir.create(write_dir)

read_dir <- "data/interim/case_studies/luo2017mice_full/vmrseq/input/"
# for (chr in paste0("chr", 1)) {
# for (chr in paste0("chr", 2)) {
# for (chr in paste0("chr", 3)) {
# for (chr in paste0("chr", 4)) {
# for (chr in paste0("chr", 5)) {
# for (chr in paste0("chr", 6)) {
# for (chr in paste0("chr", 7)) {
# for (chr in paste0("chr", 8)) {
# for (chr in paste0("chr", 9)) {
# for (chr in paste0("chr", 10)) {
# for (chr in paste0("chr", 11:12)) {
# for (chr in paste0("chr", 13:14)) {
# for (chr in paste0("chr", 15:16)) {
# for (chr in paste0("chr", 17:18)) {
for (chr in paste0("chr", 19)) {
