...
for (i in 8) wrapper(subtype_smr_sel$SubType[i], mc.cores = 10) # 3829406.pbsha.ib.sockeye
# for (i in 10:11) wrapper(subtype_smr_sel$SubType[i], mc.cores = 20) # 3825710.pbsha.ib.sockeye
