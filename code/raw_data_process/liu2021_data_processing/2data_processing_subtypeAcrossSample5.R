...
# ==== run ====
# for (i in 1) wrapper(subtype_smr_sel$SubType[i], chr_names = paste0("chr", 1:8), mc.cores = 4) # 3829869.pbsha.ib.sockeye
for (i in 1) wrapper(subtype_smr_sel$SubType[i], chr_names = paste0("chr", 9:19), mc.cores = 11) # 3830582.pbsha.ib.sockeye
