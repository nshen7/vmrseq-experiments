...
# for (i in 2) wrapper(subtype_smr_sel$SubType[i], chr_names = paste0("chr", 1:8), mc.cores = 4) # 3829864.pbsha.ib.sockeye
for (i in 2) wrapper(subtype_smr_sel$SubType[i], chr_names = paste0("chr", 9:19), mc.cores = 6) # 3829867.pbsha.ib.sockeye
