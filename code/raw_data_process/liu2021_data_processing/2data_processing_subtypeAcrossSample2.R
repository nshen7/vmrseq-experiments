...
# for (i in 6:7) wrapper(subtype_smr_sel$SubType[i], mc.cores = 20) # 3825719.pbsha.ib.sockeye
# for (i in 30:32) wrapper(subtype_smr_sel$SubType[i], mc.cores = 20) # 3825627.pbsha.ib.sockeye
# for (i in 36:33) wrapper(subtype_smr_sel$SubType[i], mc.cores = 20) # 3825674.pbsha.ib.sockeye
